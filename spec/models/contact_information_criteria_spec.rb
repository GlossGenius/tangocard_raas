...
# Unit tests for TangocardRaas::ContactInformationCriteria
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContactInformationCriteria' do
  before do
    # run before each test
    @instance = TangocardRaas::ContactInformationCriteria.new
  end
  ...
  describe 'test an instance of ContactInformationCriteria' do
    it 'should create an instance of ContactInformationCriteria' do
      expect(@instance).to be_instance_of(TangocardRaas::ContactInformationCriteria)
    end
  end
