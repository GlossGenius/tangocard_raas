...
# Unit tests for TangocardRaas::CatalogViewVerbose
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CatalogViewVerbose' do
  before do
    # run before each test
    @instance = TangocardRaas::CatalogViewVerbose.new
  end
  ...
  describe 'test an instance of CatalogViewVerbose' do
    it 'should create an instance of CatalogViewVerbose' do
      expect(@instance).to be_instance_of(TangocardRaas::CatalogViewVerbose)
    end
  end
