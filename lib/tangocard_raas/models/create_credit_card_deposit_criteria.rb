...
module TangocardRaas
  class CreateCreditCardDepositCriteria
    # Account Identifier
    attr_accessor :account_identifier

    # The amount in USD to fund
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TangocardRaas::CreateCreditCardDepositCriteria` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TangocardRaas::CreateCreditCardDepositCriteria`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @credit_card_token.nil?
        invalid_properties.push('invalid value for "credit_card_token", credit_card_token cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @credit_card_token.nil?
    ...
    def hash
      [account_identifier, amount, credit_card_token, customer_identifier].hash
    end
