...
# Unit tests for TangocardRaas::FundApi
...
describe 'FundApi' do
  ...
  describe 'test an instance of FundApi' do
    it 'should create an instance of FundApi' do
      expect(@api_instance).to be_instance_of(TangocardRaas::FundApi)
    end
  end
