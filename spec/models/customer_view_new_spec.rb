...
# Unit tests for TangocardRaas::CustomerViewNew
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomerViewNew' do
  before do
    # run before each test
    @instance = TangocardRaas::CustomerViewNew.new
  end
  ...
  describe 'test an instance of CustomerViewNew' do
    it 'should create an instance of CustomerViewNew' do
      expect(@instance).to be_instance_of(TangocardRaas::CustomerViewNew)
    end
  end
