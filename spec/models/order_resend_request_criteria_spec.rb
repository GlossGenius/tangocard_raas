...
# Unit tests for TangocardRaas::OrderResendRequestCriteria
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OrderResendRequestCriteria' do
  before do
    # run before each test
    @instance = TangocardRaas::OrderResendRequestCriteria.new
  end
  ...
  describe 'test an instance of OrderResendRequestCriteria' do
    it 'should create an instance of OrderResendRequestCriteria' do
      expect(@instance).to be_instance_of(TangocardRaas::OrderResendRequestCriteria)
    end
  end
