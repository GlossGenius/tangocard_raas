...
# Unit tests for TangocardRaas::CreditCardCriteria
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreditCardCriteria' do
  before do
    # run before each test
    @instance = TangocardRaas::CreditCardCriteria.new
  end
  ...
  describe 'test an instance of CreditCardCriteria' do
    it 'should create an instance of CreditCardCriteria' do
      expect(@instance).to be_instance_of(TangocardRaas::CreditCardCriteria)
    end
  end
