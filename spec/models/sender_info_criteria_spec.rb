...
# Unit tests for TangocardRaas::SenderInfoCriteria
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SenderInfoCriteria' do
  before do
    # run before each test
    @instance = TangocardRaas::SenderInfoCriteria.new
  end
  ...
  describe 'test an instance of SenderInfoCriteria' do
    it 'should create an instance of SenderInfoCriteria' do
      expect(@instance).to be_instance_of(TangocardRaas::SenderInfoCriteria)
    end
  end
