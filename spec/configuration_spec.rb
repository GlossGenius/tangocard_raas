...
describe TangocardRaas::Configuration do
  let(:config) { TangocardRaas::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("http://integration-api.tangocard.com/raas/v2")
    # TangocardRaas.configure do |c|
    #   c.host = uri.host
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      # expect(config.base_url).to eq("http://integration-api.tangocard.com/raas/v2")
    end
