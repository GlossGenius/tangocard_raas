...
# Unit tests for TangocardRaas::SenderInfoView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SenderInfoView' do
  before do
    # run before each test
    @instance = TangocardRaas::SenderInfoView.new
  end
  ...
  describe 'test an instance of SenderInfoView' do
    it 'should create an instance of SenderInfoView' do
      expect(@instance).to be_instance_of(TangocardRaas::SenderInfoView)
    end
  end
