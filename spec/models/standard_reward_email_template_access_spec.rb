...
# Unit tests for TangocardRaas::StandardRewardEmailTemplateAccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StandardRewardEmailTemplateAccess' do
  before do
    # run before each test
    @instance = TangocardRaas::StandardRewardEmailTemplateAccess.new
  end
  ...
  describe 'test an instance of StandardRewardEmailTemplateAccess' do
    it 'should create an instance of StandardRewardEmailTemplateAccess' do
      expect(@instance).to be_instance_of(TangocardRaas::StandardRewardEmailTemplateAccess)
    end
  end
