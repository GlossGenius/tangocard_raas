...
# Unit tests for TangocardRaas::RecipientInfoView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RecipientInfoView' do
  before do
    # run before each test
    @instance = TangocardRaas::RecipientInfoView.new
  end
  ...
  describe 'test an instance of RecipientInfoView' do
    it 'should create an instance of RecipientInfoView' do
      expect(@instance).to be_instance_of(TangocardRaas::RecipientInfoView)
    end
  end
