...
# Unit tests for TangocardRaas::RecipientInfoCriteria
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'RecipientInfoCriteria' do
  before do
    # run before each test
    @instance = TangocardRaas::RecipientInfoCriteria.new
  end
  ...
  describe 'test an instance of RecipientInfoCriteria' do
    it 'should create an instance of RecipientInfoCriteria' do
      expect(@instance).to be_instance_of(TangocardRaas::RecipientInfoCriteria)
    end
  end
