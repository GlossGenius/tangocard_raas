...
# Unit tests for TangocardRaas::CustomerViewSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CustomerViewSummary' do
  before do
    # run before each test
    @instance = TangocardRaas::CustomerViewSummary.new
  end
  ...
  describe 'test an instance of CustomerViewSummary' do
    it 'should create an instance of CustomerViewSummary' do
      expect(@instance).to be_instance_of(TangocardRaas::CustomerViewSummary)
    end
  end
