...
# Unit tests for TangocardRaas::ContactInformationView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContactInformationView' do
  before do
    # run before each test
    @instance = TangocardRaas::ContactInformationView.new
  end
  ...
  describe 'test an instance of ContactInformationView' do
    it 'should create an instance of ContactInformationView' do
      expect(@instance).to be_instance_of(TangocardRaas::ContactInformationView)
    end
  end
