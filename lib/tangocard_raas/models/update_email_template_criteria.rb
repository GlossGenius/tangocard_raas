...
module TangocardRaas
  class UpdateEmailTemplateCriteria
    # Accent Color
    ...
    def self.openapi_types
      {
        :'accent_color' => :'String',
        :'access_control' => :'Array<StandardRewardEmailTemplateAccess>',
        :'closing' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TangocardRaas::UpdateEmailTemplateCriteria` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TangocardRaas::UpdateEmailTemplateCriteria`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'access_control')
        if (value = attributes[:'access_control']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          access_control == o.access_control &&
          closing == o.closing &&
    ...
    def hash
      [accent_color, access_control, closing, customer_service_message, defaults, from_name, header_image, header_image_alt_text, message_body, name, subject].hash
    end
