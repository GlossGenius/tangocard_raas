...
# Unit tests for TangocardRaas::AccountsApi
...
describe 'AccountsApi' do
  ...
  describe 'test an instance of AccountsApi' do
    it 'should create an instance of AccountsApi' do
      expect(@api_instance).to be_instance_of(TangocardRaas::AccountsApi)
    end
  end
  ...
  # unit tests for list_customer_accounts
  # Get a list of Accounts created on this Platform.
  # @param [Hash] opts the optional parameters
  # @return [AccountView]
  describe 'list_customer_accounts test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
