  ...
  class PageView
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TangocardRaas::PageView` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TangocardRaas::PageView`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'elements_per_block')
        self.elements_per_block = attributes[:'elements_per_block']
      end
    ...
    def list_invalid_properties
      ...
      if @elements_per_block.nil?
        invalid_properties.push('invalid value for "elements_per_block", elements_per_block cannot be nil.')
      end
    ...
    def valid?
      return false if @elements_per_block.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          elements_per_block == o.elements_per_block &&
          number == o.number &&
    ...
    def hash
      [elements_per_block, number, result_count, total_count].hash
    end
