...
# Unit tests for TangocardRaas::OrderListView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OrderListView' do
  before do
    # run before each test
    @instance = TangocardRaas::OrderListView.new
  end
  ...
  describe 'test an instance of OrderListView' do
    it 'should create an instance of OrderListView' do
      expect(@instance).to be_instance_of(TangocardRaas::OrderListView)
    end
  end
