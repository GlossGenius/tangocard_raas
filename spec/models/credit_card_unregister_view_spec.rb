...
# Unit tests for TangocardRaas::CreditCardUnregisterView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreditCardUnregisterView' do
  before do
    # run before each test
    @instance = TangocardRaas::CreditCardUnregisterView.new
  end
  ...
  describe 'test an instance of CreditCardUnregisterView' do
    it 'should create an instance of CreditCardUnregisterView' do
      expect(@instance).to be_instance_of(TangocardRaas::CreditCardUnregisterView)
    end
  end
