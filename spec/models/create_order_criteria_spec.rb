...
# Unit tests for TangocardRaas::CreateOrderCriteria
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateOrderCriteria' do
  before do
    # run before each test
    @instance = TangocardRaas::CreateOrderCriteria.new
  end
  ...
  describe 'test an instance of CreateOrderCriteria' do
    it 'should create an instance of CreateOrderCriteria' do
      expect(@instance).to be_instance_of(TangocardRaas::CreateOrderCriteria)
    end
  end
