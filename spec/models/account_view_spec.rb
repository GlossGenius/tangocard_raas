...
# Unit tests for TangocardRaas::AccountView
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccountView' do
  before do
    # run before each test
    @instance = TangocardRaas::AccountView.new
  end
  ...
  describe 'test an instance of AccountView' do
    it 'should create an instance of AccountView' do
      expect(@instance).to be_instance_of(TangocardRaas::AccountView)
    end
  end
