...
module TangocardRaas
  class CatalogsApi
    ...
    # @return [Array<(CatalogViewVerbose, Integer, Hash)>] CatalogViewVerbose data, response status code and response headers
    def get_catalog_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'CatalogViewVerbose' 
