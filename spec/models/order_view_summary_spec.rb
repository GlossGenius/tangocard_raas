...
# Unit tests for TangocardRaas::OrderViewSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'OrderViewSummary' do
  before do
    # run before each test
    @instance = TangocardRaas::OrderViewSummary.new
  end
  ...
  describe 'test an instance of OrderViewSummary' do
    it 'should create an instance of OrderViewSummary' do
      expect(@instance).to be_instance_of(TangocardRaas::OrderViewSummary)
    end
  end
